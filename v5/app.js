...
// Player State
let player = JSON.parse(localStorage.getItem('syncFocusV5Player')) || {
    hp: 100,
    maxHp: 100,
    xp: 0,
    level: 1
...
function savePlayer() { localStorage.setItem('syncFocusV5Player', JSON.stringify(player)); }
...
document.addEventListener("visibilitychange", () => {
    // 【改善点】キャンプ中（isPaused）ならよそ見ダメージを受けない！
...
addFeedItem('システム', 'SyncFocus v5 へようこそ！', false, false);
